...
export const es: SiteContent = {
  ...
  about: {
    ...
    timeline: [
      ...
      { when: "2025", title: "Discurso de graduación en el Gran Rex", body: "En nombre de los egresados de ORT, ante más de 3.000 personas.", logos: ["/logos/ort.svg"] },
      ...
      { when: "2019", title: "Club Ciudad de Buenos Aires", body: "Vóley. Tres campeonatos nacionales con el club.", logos: ["/logos/club-ciudad.svg"] },
      { when: "2018", title: "GEBA", body: "Me federé en vóley.", logos: ["/logos/geba.svg"] },
      { when: "2013 — 2019", title: "Scuola Italiana Cristoforo Colombo", body: "Primaria.", logos: ["/logos/scuola-italiana.svg"] },
    ],
    nowLabel: "Ahora",
