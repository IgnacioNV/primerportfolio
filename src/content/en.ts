...
export const en: SiteContent = {
  ...
  about: {
    ...
    timeline: [
      ...
      { when: "2025", title: "Graduation speech at the Gran Rex", body: "On behalf of ORT's graduates, to more than 3,000 people.", logos: ["/logos/ort.svg"] },
      ...
      { when: "2019", title: "Club Ciudad de Buenos Aires", body: "Volleyball. Three national championships with the club.", logos: ["/logos/club-ciudad.svg"] },
      { when: "2018", title: "GEBA", body: "Started playing federated volleyball.", logos: ["/logos/geba.svg"] },
      { when: "2013 — 2019", title: "Scuola Italiana Cristoforo Colombo", body: "Primary school.", logos: ["/logos/scuola-italiana.svg"] },
    ],
    nowLabel: "Now",
